...
local output_square_triangle_complete = false
...
p_evts[#p_evts + 1] = API.Puzzle_Events.on("output_square_triangle_complete", function(errors)
	output_square_triangle_complete = true
end)

p_evts[#p_evts + 1] = API.Puzzle_Events.on("output_circle_square_triangle_complete", function(errors)
	output_circle_square_triangle_complete = true
end)

function Tick()
	if(output_triangle_complete and output_square_triangle_complete and output_circle_square_triangle_complete) then
		show_result()
	end
end
...
evts[#evts + 1] = Events.Connect("puzzle_edit", function()
	...
	output_square_triangle_complete = false
