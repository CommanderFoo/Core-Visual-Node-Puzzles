...
API.Puzzle_Events.on("output_ordered_circle_square_complete", function(errors)
...
API.Puzzle_Events.on("output_square_triangle_complete", function(errors)
	output_square_triangle_complete = true
end)

function Tick()
	if(output_ordered_circle_square_complete and output_circle_square_complete and output_square_triangle_complete) then
		show_result()
	end
end
