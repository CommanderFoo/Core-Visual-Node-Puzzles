...
translations["Column_Completed"] = "Completed"
translations["Column_Name"] = "Name"
translations["Column_Rank"] = "Rank"
translations["Column_Score"] = "Score"
translations["Column_Time_Played"] = "Time Played"
...
translations["Info_Halt"] = "This node makes sure that the data is sent to the output in the correct order.  Each Halt node will be assigned an order number based on the order you connect it to the Output Node. The order number shows in the top left of the node. To change the order, disconnect the node and reconnect it.\n\nThis node must be directly connected to an Ordered Output Node, otherwise your program will fail."
...
translations["Leaderboard_Button"] = "LEADERBOARDS"
translations["Leaderboard_Title"] = "LEADERBOARDS"
...
translations["Node_Name_Math_Greater_Than"] = "Greater Than"
translations["Node_Name_Math_Multiply"] = "Multiply"
translations["Node_Name_Math_Output"] = "Output"
translations["Node_Name_Math_Subtract"] = "Subtract"
...
translations["Total_Reroute_Nodes"] = "Total Number of Redirect Nodes"
translations["Total_View_Nodes"] = "Total Number of View Nodes"
...
translations["Tutorial_Data_Node_2"] = "Click and drag the connectors to connect up nodes to send data between them.  To remove them, left click to select, then right click to cancel."
...
translations["Tutorial_Halt"] = "Halt nodes must connect directly to an Ordered Output Node. The order they are connected will be shown in the top left corner. To change the order, disconnect all Halt Nodes from the Ordered Output Node, and reconnect them. Ordered Data 1 does not need to be halted."
