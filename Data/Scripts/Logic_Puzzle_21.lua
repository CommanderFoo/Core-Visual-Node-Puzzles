...
p_evts[#p_evts + 1] = API.Puzzle_Events.on("output_ordered_circle_plus_triangle_complete", function(errors)
...
function Tick()
	if(output_circle_square_complete and output_ordered_circle_plus_triangle_complete and output_ordered_plus_square_complete) then
		show_result()
	end
end
